...
const ShopHomepage = () => {
  ...
  // Возьмём первые 6 товаров для слайдера
    ...
    <div>
      ...
      <header className="bg-dark py-5">
        <div className="container px-4 px-lg-5 my-5">
          <div className="text-center text-white">
            <h1 className="display-4 fw-bolder">Laptopshop</h1>
            <p className="lead fw-normal text-white-50 mb-0">У нас только лучший и новый ассортимент товаров на любой вкус</p>
          </div>
        </div>
      </header>
      ...
      <footer className="py-5 bg-dark">
        <div className="container">
          <p className="m-0 text-center text-white">Магазин ноутбуков в РБ  {new Date().getFullYear()}</p>
        </div>
      </footer>
    </div>
  );
